        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white" style="background-image: url('./img/bgcover.jpg')">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        <label for="prfilephoto" class="col-sm-2 col-form-label">Profile Photo</label>
                        <div class="col-sm-10">
      ...
      updateProfile(e){
        ...
        if(file['size'] < 2111775){
          ...
          swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Your file is greater than 2MB.',
          })
        }
      }
    },

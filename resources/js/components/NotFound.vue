    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 mt-5">
                ...
                <svg id="6b5bbc3a-7ba8-40c4-8b79-fdc85beb38a1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <defs>
                        ...
                        <linearGradient id="26387a05-323e-43c3-b271-53af00551daf" x1="3013.29" y1="358.28" x2="3255.1"
                            y2="358.28" gradientTransform="matrix(-1, 0, 0, 1, 3342, 0)"
                            xlink:href="#fb7ae7e0-1793-4d3b-a6c6-7b51ed07a232" />
                    </defs>
                    <title>warning</title>
                    <ellipse cx="530.99" cy="416.32" rx="466.48" ry="416.32" fill="#6c63ff" opacity="0.1" />
                    <ellipse cx="172" cy="629.28" rx="172" ry="26.66" fill="#6c63ff" opacity="0.1" />
                    <ellipse cx="254.67" cy="769.13" rx="66.9" ry="13.82" fill="#6c63ff" opacity="0.1" />
                    <ellipse cx="711.8" cy="715.96" rx="66.9" ry="13.82" fill="#6c63ff" opacity="0.1" />
                    <ellipse cx="484.79" cy="699.75" rx="108.79" ry="18.43" fill="#6c63ff" opacity="0.1" />
                    <ellipse cx="805.34" cy="608.52" rx="226.91" ry="35.54" fill="#6c63ff" opacity="0.1" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-83.88 -33.68)" fill="#fff" opacity="0.1" />
                    <path d="M271.07,581.5s29.81,27.13,27,68.88" transform="translate(-83.88 -33.68)" opacity="0.1" />
                    <path d="M321.22,496.06s-31.28,41.6-34.79,105.61" transform="translate(-83.88 -33.68)"
                        opacity="0.1" />
                    <path d="M213.86,478.43S229,547.18,191.2,599" transform="translate(-83.88 -33.68)" opacity="0.1" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-83.88 -33.68)" fill="#6c63ff" />
                    <path
                    ...
                    <path d="M338.55,240.74l-4-7.55a7.31,7.31,0,0,1,.83-.84,3.17,3.17,0,0,1,1.93-.46Z"
                        transform="translate(-83.88 -33.68)" opacity="0.1" />
                    <path d="M349.58,231.54l-4.53,6.7-2.58-7.35a8.18,8.18,0,0,1,3.49-.66A11.6,11.6,0,0,1,349.58,231.54Z"
                        transform="translate(-83.88 -33.68)" opacity="0.1" />
                    <g opacity="0.1">
                        <path
                    ...
                    <path
                        ...
                        transform="translate(-83.88 -33.68)" fill="#a8a8a8" />
                    <path d="M728.77,614.86s16.3-22.81,15.48-39.11,3.84-56,3.84-56" transform="translate(-83.88 -33.68)"
                    ...
                    <path d="M949.54,581.46s4.88,17.1,11.4,26.88,16.29,44.8,16.29,44.8"
                        transform="translate(-83.88 -33.68)" fill="none" stroke="#000" stroke-miterlimit="10"
                        opacity="0.1" />
                    <path d="M1026.11,631.15s10.34,28.77,19.43,29.05" transform="translate(-83.88 -33.68)" fill="none"
                        stroke="#000" stroke-miterlimit="10" opacity="0.1" />
                    <path d="M958.38,507.66s26.86,7.26,38.09,24.85S1042,566.05,1042,566.05"
                        transform="translate(-83.88 -33.68)" fill="none" stroke="#000" stroke-miterlimit="10"
                        opacity="0.1" />
                    <path d="M969.9,421s0,37.47,10.59,37.47,34.22,4.07,34.22,4.07" transform="translate(-83.88 -33.68)"
                        fill="none" stroke="#000" stroke-miterlimit="10" opacity="0.1" />
                    ...
                    <path
                        ...
                        transform="translate(-83.88 -33.68)" fill="#6c63ff" opacity="0.1" />
                    <path
